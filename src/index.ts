...
export function findRepos(dir: string, recursive = true): string[] {
...
export function getCommits(repoPath: string, since: string, until: string, author?: string): Commit[] {
...
export function generateStandup(options: StandupOptions = {}): StandupReport {
...
export function formatMarkdown(report: StandupReport): string {
  if (report.totalCommits === 0) {
